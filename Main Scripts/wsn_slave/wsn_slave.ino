...
//  @version 0.1  
//  
//  version 0.1: Inherited from hc06_sensor.ino. 
//
//  A sketch that runs on an HC-06 slave.
//  It reads temperature and humidity values from a DHT11 sensor and sends them to the master via Bluetooth.
...
//
//  DHT11 OUT to Arduino pin 7
//  DHT11 + to Arduino 5V out
//  DHT11 - to Arduino GND 
  ...
  if (BTSerial.available()){
    ...
    if(connectionConfirmation == "P"){
      //for(byte i = 0; i<10; i++){
        ...
        BTSerial.println("T"+tempString + ";"+ humString + "\n");
